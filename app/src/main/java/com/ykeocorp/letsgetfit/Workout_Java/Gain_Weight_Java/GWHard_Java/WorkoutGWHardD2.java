...
public class WorkoutGWHardD2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_gwhard_d2);

        GWHD2 = (ListView) findViewById(R.id.GWHD2);

        WorkoutGWHardD2.CustomAdapter customAdapter = new WorkoutGWHardD2.CustomAdapter();

        GWHD2.setAdapter(customAdapter);
    }
