...
public class WorkoutLWHardD17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d17);

        LWHD17 = (ListView) findViewById(R.id.LWHD17);

        WorkoutLWHardD17.CustomAdapter customAdapter = new WorkoutLWHardD17.CustomAdapter();

        LWHD17.setAdapter(customAdapter);
    }
