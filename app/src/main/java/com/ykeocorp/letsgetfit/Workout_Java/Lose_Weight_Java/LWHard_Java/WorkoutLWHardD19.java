...
public class WorkoutLWHardD19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d19);

        LWHD19 = (ListView) findViewById(R.id.LWHD19);

        WorkoutLWHardD19.CustomAdapter customAdapter = new WorkoutLWHardD19.CustomAdapter();

        LWHD19.setAdapter(customAdapter);
    }
