...
public class WorkoutLWHardD20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d20);

        LWHD20 = (ListView) findViewById(R.id.LWHD20);

        WorkoutLWHardD20.CustomAdapter customAdapter = new WorkoutLWHardD20.CustomAdapter();

        LWHD20.setAdapter(customAdapter);
    }
