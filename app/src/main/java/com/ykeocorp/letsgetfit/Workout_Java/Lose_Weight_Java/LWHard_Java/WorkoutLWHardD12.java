...
public class WorkoutLWHardD12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d12);

        LWHD12 = (ListView) findViewById(R.id.LWHD12);

        WorkoutLWHardD12.CustomAdapter customAdapter = new WorkoutLWHardD12.CustomAdapter();

        LWHD12.setAdapter(customAdapter);
    }
