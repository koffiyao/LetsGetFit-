...
public class WorkoutGWHardD10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_gwhard_d10);

        GWHD10 = (ListView) findViewById(R.id.GWHD10);

        WorkoutGWHardD10.CustomAdapter customAdapter = new WorkoutGWHardD10.CustomAdapter();

        GWHD10.setAdapter(customAdapter);
    }
