...
public class WorkoutGWHardD7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_gwhard_d7);

        GWHD7 = (ListView) findViewById(R.id.GWHD7);

        WorkoutGWHardD7.CustomAdapter customAdapter = new WorkoutGWHardD7.CustomAdapter();

        GWHD7.setAdapter(customAdapter);
    }
