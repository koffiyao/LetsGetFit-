...
public class WorkoutLWEasyD5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lweasy_d5);

        LWED5 = (ListView) findViewById(R.id.LWED5);

        WorkoutLWEasyD5.CustomAdapter customAdapter = new WorkoutLWEasyD5.CustomAdapter();

        LWED5.setAdapter(customAdapter);
    }
