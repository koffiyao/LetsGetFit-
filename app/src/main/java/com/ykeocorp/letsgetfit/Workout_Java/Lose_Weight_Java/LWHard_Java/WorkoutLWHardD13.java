...
public class WorkoutLWHardD13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d13);

        LWHD13 = (ListView) findViewById(R.id.LWHD13);

        WorkoutLWHardD13.CustomAdapter customAdapter = new WorkoutLWHardD13.CustomAdapter();

        LWHD13.setAdapter(customAdapter);
    }
