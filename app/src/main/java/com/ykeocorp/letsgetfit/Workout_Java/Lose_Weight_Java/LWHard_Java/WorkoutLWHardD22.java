...
public class WorkoutLWHardD22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d22);

        LWHD22 = (ListView) findViewById(R.id.LWHD22);

        WorkoutLWHardD22.CustomAdapter customAdapter = new WorkoutLWHardD22.CustomAdapter();

        LWHD22.setAdapter(customAdapter);
    }
