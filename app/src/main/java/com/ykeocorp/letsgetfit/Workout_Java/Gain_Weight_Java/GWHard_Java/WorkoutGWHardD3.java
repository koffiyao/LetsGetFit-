...
public class WorkoutGWHardD3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_gwhard_d3);

        GWHD3 = (ListView) findViewById(R.id.GWHD3);

        WorkoutGWHardD3.CustomAdapter customAdapter = new WorkoutGWHardD3.CustomAdapter();

        GWHD3.setAdapter(customAdapter);
    }
