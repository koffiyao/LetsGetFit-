...
public class WorkoutLWHardD24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d24);

        LWHD24 = (ListView) findViewById(R.id.LWHD24);

        WorkoutLWHardD24.CustomAdapter customAdapter = new WorkoutLWHardD24.CustomAdapter();

        LWHD24.setAdapter(customAdapter);
    }
