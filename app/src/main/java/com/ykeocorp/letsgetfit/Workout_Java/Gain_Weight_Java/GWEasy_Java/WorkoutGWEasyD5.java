...
public class WorkoutGWEasyD5 extends AppCompatActivity {
    ...
    final String[] workouts = {"Barbell Squats", "Deadlifts", "Standing Calf Raises", "Bench Press", "Push Ups", "Pull Ups", "Lats Pulldown"};

    String[] repetition = {"3 sets, 10 reps (1-2 min rest)", "3 sets, 10 reps (1-2 min rest)", "3 sets, 10 reps (1-2 min rest)",
            "3 sets, 10 reps (1-2 min rest)", "3 sets, 6-10 reps (1-2 min rest)", "3 sets, 2-4 reps (1-2 min rest)",
            "3 sets, 10 reps (1-2 min rest)"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_workout_gweasy_d5);

        GWED5 = (ListView) findViewById(R.id.GWED5);

        WorkoutGWEasyD5.CustomAdapter customAdapter = new WorkoutGWEasyD5.CustomAdapter();

        GWED5.setAdapter(customAdapter);
    }
