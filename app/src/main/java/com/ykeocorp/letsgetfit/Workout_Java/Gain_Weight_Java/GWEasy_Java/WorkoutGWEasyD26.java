...
public class WorkoutGWEasyD26 extends AppCompatActivity {

    ListView GWED26;

    // components of the list on the screen
    int[] images = {R.drawable.barbellsquat, R.drawable.standingcalfraises, R.drawable.benchpress, R.drawable.pushup,
            R.drawable.pullup, R.drawable.latspulldown, R.drawable.seatedrow, R.drawable.tricepspushdown, R.drawable.barbellcurl};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_gweasy_d26);

        GWED26 = (ListView) findViewById(R.id.GWED26);

        WorkoutGWEasyD26.CustomAdapter customAdapter = new WorkoutGWEasyD26.CustomAdapter();

        GWED26.setAdapter(customAdapter);
    }
