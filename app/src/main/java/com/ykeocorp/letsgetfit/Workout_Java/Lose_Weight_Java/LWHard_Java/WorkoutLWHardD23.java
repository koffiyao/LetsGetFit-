...
public class WorkoutLWHardD23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lwhard_d23);

        LWHD23 = (ListView) findViewById(R.id.LWHD23);

        WorkoutLWHardD23.CustomAdapter customAdapter = new WorkoutLWHardD23.CustomAdapter();

        LWHD23.setAdapter(customAdapter);
    }
