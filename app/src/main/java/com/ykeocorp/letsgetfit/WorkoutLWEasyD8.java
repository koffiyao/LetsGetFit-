...
public class WorkoutLWEasyD8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lweasy_d8);

        LWED8 = (ListView) findViewById(R.id.LWED8);

        WorkoutLWEasyD8.CustomAdapter customAdapter = new WorkoutLWEasyD8.CustomAdapter();

        LWED8.setAdapter(customAdapter);
    }
