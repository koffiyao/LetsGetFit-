...
public class WorkoutLWEasyD15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_lweasy_d15);

        LWED15 = (ListView) findViewById(R.id.LWED15);

        WorkoutLWEasyD15.CustomAdapter customAdapter = new WorkoutLWEasyD15.CustomAdapter();

        LWED15.setAdapter(customAdapter);
    }
